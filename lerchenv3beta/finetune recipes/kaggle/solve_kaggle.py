model_pth = "/kaggle/input/deepseek-r1/transformers/deepseek-r1-distill-qwen-7b/2"
SFT_CSV_PATH = "/kaggle/input/sfthnumina/sft_formatted_hnumina.csv"
NUM_ROWS = 1600
BATCH_NUM = 0
GRAD_ACC = 4
DEV_BATCH_SIZE = 1
...
trainer = SFTTrainer(
    ...
    args=TrainingArguments(
        ...
        warmup_ratio=0.05,
        num_train_epochs=1,            # Reduced epochs for faster iteration
        learning_rate=2e-5,
...
trainer = train_on_responses_only(
    # THIS WORKS
    trainer,
    instruction_part="<｜begin▁of▁sentence｜>",  # beginning of the chat (unique to be safe).
